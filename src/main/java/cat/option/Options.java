...
import cat.Const;
import cat.exception.IllegalOptionException;
import cat.option.impl.DelegateOption;
import cat.option.impl.HelpOption;
import cat.option.impl.NumberNonBlankOption;
import cat.option.impl.NumberOption;
import cat.option.impl.ShowEndsOption;
import cat.option.impl.ShowNonPrintingOption;
import cat.option.impl.ShowTabsOption;
import cat.option.impl.SqueezeBlankOption;
import cat.option.impl.VersionOption;
...
public enum Options {
    ...
    public static Options findByShortOption(String option) {
        ...
        throw new IllegalOptionException("invalid option -- '" + option + "'");
    }
    ...
    public static Options findByLongOption(String option) {
        ...
        throw new IllegalOptionException("unrecognized option '--" + option + "'");
    }
}
